...
function Navbar() {
  return (
    <nav className="flex flex-col md:flex-row justify-between md:items-center px-8 py-4 border-b gap-2 md:gap-0 border-zinc-700 fixed w-full bg-zinc-900 z-50 left-0">
      
      {/* Nama */}
      <a className="text-2xl font-bold text-emerald-300" href="/">
        Syahrul Ramadhan
      </a>
      ...
      <div className="flex gap-5 items-center">
        ...
        >
          <svg viewBox="0 0 382 382" className="w-6 h-6 fill-current">
        ...
        {/* Resume Button */}
        <a
          href="/resume/SyahrulRamadhanResume.pdf"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 border border-indigo-300 text-indigo-300 px-4 py-2 rounded-xl hover:bg-indigo-300 hover:text-zinc-900 transition"
        >
          Resume
